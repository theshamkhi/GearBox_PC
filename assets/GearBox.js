...
function loadCartDataOnDevisPage() {
    ...
    savedCartItems.forEach(item => {
        ...
        itemElement.className="border-b border-neutral-200"
        itemElement.innerHTML = `
            <td class="whitespace-nowrap px-6 py-4"> ${item.productName}</td>
            <td class="whitespace-nowrap px-6 py-4"> ${item.promotionalPrice} MAD</td>
            <td class="whitespace-nowrap px-6 py-4"> ${item.quantity}</td>
            <td class="whitespace-nowrap px-6 py-4"> ${item.totalPrice}</td>
        `;
